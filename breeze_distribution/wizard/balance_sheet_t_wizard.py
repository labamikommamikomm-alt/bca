...
class BalanceSheetTWizard(models.TransientModel):
    ...
    def action_print_report(self):
        ...
        # Mengembalikan aksi laporan, mengirimkan data dari wizard
        return self.env.ref('breeze_distribution.action_report_balance_sheet_t').report_action(self, data=data)
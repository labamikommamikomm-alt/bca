# -*- coding: utf-8 -*-
{
    ...
    'depends': ['base', 'stock', 'purchase', 'sale', 'hr', 'l10n_id_efaktur', 'peminjaman', 'extra_price'],
    ...
    'data': [
        ...
        'wizard/report_rekap_piutang_perbulan.xml',
        'wizard/report_rekap_piutang_persales.xml',
        ...
        'wizard/general_ledger_report_line_view.xml',
        ...
        'report/report_rekap_piutang_perbulan.xml',
        'report/report_rekap_piutang_persales.xml',
        ...
        'report/report.xml',
        'wizard/export_invoice_recap_wizard_view.xml',
        'report/report_invoice_recap.xml',
        'wizard/inherit_register_payment.xml',
        'wizard/export_vendor_bill_wizard_view.xml',
        'report/report_export_vendor_bill.xml',
